...
public class ContactPage extends BaseClass {
	...
	public void submitValidData() throws IOException, InterruptedException {

		SendKeysClass.sendKeysMethod(txtForeName, "NameTestTen", "txtForeName");
		SendKeysClass.sendKeysMethod(txtSurName, "SurNameTen", "txtSurName");
		SendKeysClass.sendKeysMethod(txtEmail, "test10@gmail.com", "txtEmail");
		SendKeysClass.sendKeysMethod(txtTelepnone, "0430256310", "txtTelepnone");
	...
	public void submitInvalidData() throws IOException, InterruptedException {

		SendKeysClass.sendKeysMethod(txtForeName, "      ", "txtForeName");
		
		SendKeysClass.sendKeysMethod(txtEmail, "    ", "txtEmail");
	
		SendKeysClass.sendKeysMethod(txtMessage, "     ", "txtMessage");
